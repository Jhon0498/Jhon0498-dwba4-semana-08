...
const arrayAlunos = [new Aluno("Jhonatan", "Mendes", 5, 5), new Aluno("João", "Silva", 7, 8), new Aluno("Maria", " Souza", 9, 10), new Aluno("Pedro", "Santos", 4, 3), new Aluno("Ana", "Pereira", 6, 7)];
